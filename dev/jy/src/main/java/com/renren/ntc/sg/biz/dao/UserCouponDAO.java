...
public interface UserCouponDAO {
    ...
    static final String  FIELDS = "id,user_id,coupon_id,code,status, price ,name  ,ext,start_time,end_time,create_time,update_time"  ;
    static final String  INSERT_FIELDS = "user_id,coupon_id,code ,status, price ,name,ext,start_time,end_time"  ;
    ...
    @SQL("insert into " + TABLE_NAME + " ( " + INSERT_FIELDS + ") values (:1.user_id,:1.coupon_id,:1.code ,:1.status,:1.price ," +
