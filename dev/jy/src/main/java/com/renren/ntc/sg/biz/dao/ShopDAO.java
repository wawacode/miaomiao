...
public interface ShopDAO {
    ...
    static final String INSERT_FIELDS = "owner_user_id,name,shop_address,tel,owner_phone,head_url,shop_url,shop_info,lng,lat" ;
    ...
    @ReturnGeneratedKeys
	@SQL("insert into " + TABLE_NAME + "(" + INSERT_FIELDS +" ) values"  + " (:1.owner_user_id,:1.name,:1.shop_address,:1.tel,:1.owner_phone,:1.head_url,:1.shop_url,:1.shop_info,:1.lng,:1.lat)")
