...
public interface ItemsDAO {
    ...
    public int getItemsCount(@SQLParam("tableName") String generTableName);
     ...
     * @return
     */
    @SQL("SELECT COUNT(*) FROM ##(:tableName) WHERE  price = 0 AND pic_url ='' ")
    public int getItemsNotPicUrlAndPriceIsZeroCount(@SQLParam("tableName") String generTableName);

    @SQL("SELECT COUNT(*) FROM ##(:tableName) WHERE pic_url ='' ")
    public int getItemsNotPicUrl(@SQLParam("tableName") String generTableName);

    @SQL("SELECT COUNT(*) FROM ##(:tableName) WHERE  price = 0")
    public int getItemsPriceIsZeroCount(@SQLParam("tableName") String generTableName);
}
