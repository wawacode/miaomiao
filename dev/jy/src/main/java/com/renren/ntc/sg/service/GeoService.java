...
import com.renren.ntc.sg.geo.AbstractGeoMongodbService;
import com.renren.ntc.sg.geo.GeoMongodbService2dSphere;
...
public class GeoService {
	 ...
	 * @return
	 */
	public List<GeoQueryResult> queryNear(ShopLocation uloc,int r ) {
		return this.queryNear(uloc, r, DEFAULT_MAX_NUM);
	}
	 ...
	 * @return
	 */
	public List<GeoQueryResult> queryNear(ShopLocation uloc, int maxDistance, int maxNum) {
    ...
    public static void main (String [] args){
        //116.509389,39.930979
        GeoService geoService =  new GeoService() ;
        ShopLocation shopN = new ShopLocation () ;
        shopN.setShop_id(10014);
        shopN.setLatitude(39.979473114014);
        shopN.setLongitude(116.304931640625);
        geoService.updateLocation(shopN);
//
//        ShopLocation shopL = new ShopLocation () ;
//        shopL.setShop_id(1);
//        shopL.setLatitude(39.931073);
//        shopL.setLongitude(116.50938);
//        List<GeoQueryResult> ls  = geoService.queryNear(shopL, 1 * 1000);
