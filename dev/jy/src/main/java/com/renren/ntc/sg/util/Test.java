...
public class Test {
    ...
    public static void main (String [] args ){
        ...
        try {
           byte[] ss = "车".getBytes("gbk");
           for ( byte s : ss){
               String sdds = Integer.toBinaryString((int)s).substring(24);
               System.out.println(Integer.toBinaryString((int)s).substring(24));
               System.out.println(Integer.toHexString(Integer.valueOf(sdds,2)));
