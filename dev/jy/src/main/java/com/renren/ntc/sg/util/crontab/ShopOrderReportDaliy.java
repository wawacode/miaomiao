...
public class ShopOrderReportDaliy {
	public static void main(String[] args) {
	  ...
	  for(Shop shop : shops){
		...
		List<ShopOrderFlow> shopOrderFlows = new ArrayList<ShopOrderFlow>();
	  ...
	  MailSendServer mailSendServer = MailSendServer.getServer("smtp.163.com", 25, "lee_yeah1@163.com", "Lee1qaz2wsx",
              "lee_yeah1@163.com");
