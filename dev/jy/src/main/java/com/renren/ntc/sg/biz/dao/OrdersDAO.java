...
public interface OrdersDAO {
    ...
    @SQL("select "+ FIELDS +" from ##(:tableName)   where shop_id =:2 and act = 'wx' and (status = 1 or status =2) and (order_stauts = 4 and user_confirm_time between :3 and :4) or (order_status=5 and create_time between :3 and :4) ")
    ...
    @SQL("select "+ FIELDS +" from ##(:tableName)   where shop_id =:2 and act = 'wx' and (status = 1 or status =2) and order_stauts = 4 and user_confirm_time between :3 and :4 ")
