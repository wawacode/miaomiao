...
public interface PushTokenDAO {
    ...
    static final String FIELDS = "id, ower_phone ,device_token, create_time" ;
    static final String INSERT_FIELDS = "ower_phone ,device_token" ;
    ...
    @SQL("insert  into " +TABLE_NAME +" (" +  INSERT_FIELDS +") " +   " values" +
            "(:1.ower_phone,:1.device_token) ON DUPLICATE KEY UPDATE device_token=:1.device_token")
