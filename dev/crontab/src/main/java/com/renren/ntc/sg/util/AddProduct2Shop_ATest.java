...
public class AddProduct2Shop_ATest {

    private static int shop_id = 10041;
    ...
    public static void main(String[] args) throws IOException {
        ...
        // 读取第一章表格内容
        AddProduct2Shop_ATest addProduct = new AddProduct2Shop_ATest();
        String filePath = "C:\\20150323\\aaa.txt";
