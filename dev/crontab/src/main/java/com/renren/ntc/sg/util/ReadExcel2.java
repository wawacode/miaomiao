...
public class ReadExcel2 {
    ...
    public ReadExcel2() throws IOException {
    ...
    public static void main(String[] args) throws IOException {
        ...
        for (int k = 0; k < 1; k++) {
            ...
            for (int i = sheet.getFirstRowNum(); i < sheet.getPhysicalNumberOfRows(); i++) {
                ...
                if (!StringUtils.isEmpty(it.getPic_url()) && !StringUtils.isEmpty(it.getSerialNo()) && it.getPic_url().length() < 256) {
