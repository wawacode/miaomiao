...
public interface RegistUserDAO {
    ...
    static final String INSERT_FIELDS = "name,phone,enable,type,pwd,phone" ;
    ...
    @ReturnGeneratedKeys
    @SQL("insert into  "  + TABLE_NAME + " (" + INSERT_FIELDS  +") values (:1.name,:1.enable,:1.type,:1.pwd , 1.phone)")
