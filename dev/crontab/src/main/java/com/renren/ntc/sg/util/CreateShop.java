...
public class CreateShop {
    ...
    public static String admin_phone= "68955555" ;
    ...
    private static void insert(ShopDAO shopDao, ShopCategoryDAO shopCategoryDao, RegistUserDAO registUserDAO,DeviceDAO deviceDao,ItemsDAO itemDao) {
        ...
        System.out.println(String.format("create new shop admin  %d , name %s ,  pwd %d ",admin_id ,admin_name , admin_pwd));
        // 初始化店铺
        Shop shop =  new Shop();
        ...
        for (Item it : itl ){
            ...
            itemDao.insert(SUtils.generTableName(BASE_SHOP),it) ;
        }
        // 结束并打印程序
