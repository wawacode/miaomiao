;angular.module('miaomiao.console.controllers')
    .controller('ShopListCtrl', ['$scope', '$state', '$filter', '$ionicPopup', '$ionicModal', 'localStorageService',
        '$ionicLoading', 'httpClient', '$ionicScrollDelegate', '$timeout',
        ...
        function ($scope, $state, $filter, $ionicPopup, $ionicModal, localStorageService, $ionicLoading, httpClient, $ionicScrollDelegate, $timeout) {
            ...
            $scope.info.defaultShop = localStorageService.get('MMCONSOLE_METADATA_DEFAULT_SHOP') ||
                ($scope.info.shoplist && $scope.info.shoplist[0]);
